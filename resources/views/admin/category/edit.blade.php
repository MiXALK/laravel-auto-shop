        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_content">
                        @if(count($category))
                        <form class="form-horizontal form-label-left" novalidate action="/admin/category/{{$category->id}}" method="post">
                            {{ csrf_field() }}
                            @method('PATCH')
                            <span class="section">Редактировать раздел</span>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Название раздела <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="title" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="title" placeholder="" required="required" type="text" value="{{$category->title}}">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="slug" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" readonly name="slug" placeholder="" required="required" type="text" value="{{$category->slug}}">
                                </div>
                            </div>
                            <div class="item form-group">
